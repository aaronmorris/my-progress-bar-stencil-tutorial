...
function formatFileName(cwd, fileName, startLineNumber = null, startCharNumber = null) {
    if (!fileName)
        return '';
    if (cwd) {
...
function formatHeader(type, fileName, cwd, startLineNumber = null, startCharNumber = null) {
...
function generateBuildResults(config, compilerCtx, buildCtx) {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        const buildResults = {
            ...
            components: [],
            entries: yield Promise.all(buildCtx.entryModules.map(en => {
...
function getEntryModule(config, buildCtx, getGzipSize, en) {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        const buildEntry = yield getBuildEntry(config, getGzipSize, entryCmps, en);
...
function getBuildEntry(config, getGzipSize, entryCmps, en) {
    return __awaiter$2(this, void 0, void 0, function* () {
        const buildEntry = {
            entryId: en.entryKey,
            ...
            bundles: yield Promise.all(en.entryBundles.map(entryBundle => {
...
function getBuildBundle(config, entryBundle, getGzipSize) {
    return __awaiter$2(this, void 0, void 0, function* () {
        const buildBundle = {
        ...
        if (getGzipSize) {
            buildBundle.gzip = yield config.sys.gzipSize(entryBundle.text);
        }
...
function copyComponentStyles(config, compilerCtx, buildCtx) {
    return __awaiter$4(this, void 0, void 0, function* () {
        ...
        try {
            ...
            absSrcStylePaths.map((absSrcStylePath) => __awaiter$4(this, void 0, void 0, function* () {
...
function copyEsmCorePolyfills(config, compilerCtx, outputTarget) {
    return __awaiter$6(this, void 0, void 0, function* () {
        ...
        yield POLYFILLS.map((polyfillFile) => __awaiter$6(this, void 0, void 0, function* () {
...
function generateEsmEs5(config, compilerCtx, cmpRegistry, outputTarget) {
    return __awaiter$8(this, void 0, void 0, function* () {
        const c = yield Promise.all(Object.keys(cmpRegistry).sort().map((tagName) => __awaiter$8(this, void 0, void 0, function* () {
            const cmpMeta = cmpRegistry[tagName];
...
function generateTypes(config, compilerCtx, outputTarget, buildCtx, pkgData) {
    return __awaiter$a(this, void 0, void 0, function* () {
        ...
        yield Promise.all(srcDtsFiles.map((srcDtsFile) => __awaiter$a(this, void 0, void 0, function* () {
...
function copyTasks(config, compilerCtx, diagnostics, commit) {
    return __awaiter$c(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield Promise.all(copyTasks.map((copyTask) => __awaiter$c(this, void 0, void 0, function* () {
                yield processCopyTasks(config, compilerCtx, allCopyTasks, copyTask);
            })));
            yield Promise.all(allCopyTasks.map((copyTask) => __awaiter$c(this, void 0, void 0, function* () {
...
class InMemoryFileSystem {
    ...
    copyDir(src, dest, opts) {
        return __awaiter$e(this, void 0, void 0, function* () {
            ...
            yield Promise.all(dirItems.map((dirItem) => __awaiter$e(this, void 0, void 0, function* () {
    ...
    removeDir(dirPath) {
        return __awaiter$e(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(dirItems.map((item) => __awaiter$e(this, void 0, void 0, function* () {
    ...
    commitWriteFiles(filesToWrite) {
        return Promise.all(filesToWrite.map((filePath) => __awaiter$e(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
    ...
    commitDeleteFiles(filesToDelete) {
        return Promise.all(filesToDelete.map((filePath) => __awaiter$e(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
...
class WatcherListener {
    ...
    queueCopyTasks() {
        ...
        this.copyTaskTmr = setTimeout(() => __awaiter$g(this, void 0, void 0, function* () {
...
function getBuildContext(config, compilerCtx, watcher) {
    ...
    buildCtx.finish = () => __awaiter$h(this, void 0, void 0, function* () {
        try {
        ...
        const results = yield finishBuild(config, compilerCtx, buildCtx);
        if (!config.watch) {
            config.sys.destroy();
        }
        return results;
...
function finishBuild(config, compilerCtx, buildCtx) {
    return __awaiter$h(this, void 0, void 0, function* () {
        const buildResults = yield generateBuildResults(config, compilerCtx, buildCtx);
...
function generateComponentTypes(config, compilerCtx, buildCtx, tsOptions, tsHost, tsFilePaths, componentsDtsSrcFilePath) {
    return __awaiter$m(this, void 0, void 0, function* () {
        ...
        yield Promise.all(typesOutputTargets.map((outputTarget) => __awaiter$m(this, void 0, void 0, function* () {
...
function scanDirForTsFiles(config, fs, dir) {
    return __awaiter$o(this, void 0, void 0, function* () {
        ...
        yield Promise.all(tsFileItems.map((tsFileItem) => __awaiter$o(this, void 0, void 0, function* () {
...
function minifyStyle(config, compilerCtx, diagnostics, styleText, filePath) {
    return __awaiter$y(this, void 0, void 0, function* () {
        ...
        const minifyResults = yield config.sys.minifyCss(styleText, filePath, opts);
...
const MINIFY_CSS_DEV = {
    level: 0,
    format: 'beautify'
};
function resolveNodeModuleCssImports(config, diagnostics, styleText, filePath, hasCssImport) {
...
function getNodeImports(styleText) {
    const matches = [];
...
function replaceNodeModuleUrl(config, baseCssFilePath, moduleId, nodeModulePath, url) {
...
function initHostSnapshot(domApi, cmpMeta, hostElm, hostSnapshot, attribName) {
    ...
    // let's first take a snapshot of its original layout before render
    {
        ...
        if (cmpMeta.encapsulation === 2 /* ScopedCss */ || (cmpMeta.encapsulation === 1 /* ShadowDom */ && !domApi.$supportsShadowDom)) {
...
function hydrateHtml(config, compilerCtx, outputTarget, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$A(this, void 0, void 0, function* () {
            if (config._isTesting) {
...
function loadGlobalStyle(config, compilerCtx, buildCtx, filePath) {
    return __awaiter$R(this, void 0, void 0, function* () {
        ...
        try {
            ...
            style = yield minifyStyle(config, compilerCtx, buildCtx.diagnostics, style, filePath);
        }
        catch (e) {
...
function generateBundles(config, compilerCtx, buildCtx, entryModules, jsModules) {
    return __awaiter$U(this, void 0, void 0, function* () {
        ...
        const bundleKeys = {};
        yield Promise.all(entryModules.map((entryModule) => __awaiter$U(this, void 0, void 0, function* () {
            ...
            return Promise.all(entryModule.modeNames.map((modeName) => __awaiter$U(this, void 0, void 0, function* () {
...
function genereateBrowserEsm(config, compilerCtx, jsModules, bundleKeys) {
    return __awaiter$U(this, void 0, void 0, function* () {
        ...
        const esmPromises = Object.keys(esmModules)
            ...
            .map(([key, value]) => __awaiter$U(this, void 0, void 0, function* () {
...
function genereateEsmEs5(config, compilerCtx, buildCtx, jsModules, bundleKeys) {
    return __awaiter$U(this, void 0, void 0, function* () {
        ...
        yield Promise.all(distOutputs.map((distOutput) => __awaiter$U(this, void 0, void 0, function* () {
...
function generateBundleBrowserBuild(config, compilerCtx, entryModule, jsText, bundleId, modeName, isScopedStyles, sourceTarget) {
    return __awaiter$U(this, void 0, void 0, function* () {
        ...
        return Promise.all(outputTargets.map((outputTarget) => __awaiter$U(this, void 0, void 0, function* () {
...
function scopeComponentCss(config, buildCtx, cmpMeta, cssText) {
    return __awaiter$V(this, void 0, void 0, function* () {
        try {
            ...
            cssText = yield config.sys.scopeCss(cssText, scopeAttribute, hostScopeAttr, slotScopeAttr);
        }
        catch (e) {
            catchError(buildCtx.diagnostics, e);
        }
...
function generateStyles(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter$W(this, void 0, void 0, function* () {
        ...
        yield Promise.all(entryModules.map((bundle) => __awaiter$W(this, void 0, void 0, function* () {
            yield Promise.all(bundle.moduleFiles.map((moduleFile) => __awaiter$W(this, void 0, void 0, function* () {
...
function generateComponentStyles(config, compilerCtx, buildCtx, moduleFile) {
    return __awaiter$W(this, void 0, void 0, function* () {
        ...
        yield Promise.all(Object.keys(stylesMeta).map((modeName) => __awaiter$W(this, void 0, void 0, function* () {
...
function compileExternalStyle(config, compilerCtx, buildCtx, moduleFile, extStylePath) {
    return __awaiter$W(this, void 0, void 0, function* () {
        ...
        if (!moduleFile.isCollectionDependency) {
            ...
            yield Promise.all(collectionDirs.map((outputTarget) => __awaiter$W(this, void 0, void 0, function* () {
...
function setStyleText(config, compilerCtx, buildCtx, cmpMeta, styleMeta, styles) {
    return __awaiter$W(this, void 0, void 0, function* () {
        ...
        if (requiresScopedStyles(cmpMeta.encapsulation)) {
            ...
            styleMeta.compiledStyleTextScoped = yield scopeComponentCss(config, buildCtx, cmpMeta, styleMeta.compiledStyleText);
        }
    ...
    return __awaiter$10(this, void 0, void 0, function* () {
        const promises = Object.keys(results).map((moduleType) => {
            ...
            const promises = Object.keys(jsModuleList)
                ...
                .map((chunk) => __awaiter$10(this, void 0, void 0, function* () {
                if (!chunk || !chunk.code) {
                    return;
                }
...
function createDoUpgrade(config, compilerCtx, buildCtx) {
    return (collection, upgrades) => __awaiter$12(this, void 0, void 0, function* () {
        ...
        yield Promise.all(collection.moduleFiles.map((moduleFile) => __awaiter$12(this, void 0, void 0, function* () {
            try {
...
function initCollections(config, compilerCtx, buildCtx) {
    return __awaiter$13(this, void 0, void 0, function* () {
        ...
        return Promise.all(uninitialized.map((collection) => __awaiter$13(this, void 0, void 0, function* () {
